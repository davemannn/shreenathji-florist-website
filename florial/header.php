...
/**
 * Version:            1.0.0
 * Theme Name:         florial * Theme URI:          http://wpbingosite.com/themes/florial/
 * Author:             Wpbingo
							...
							<?php if($show_minicart || $show_searchform){ ?>
								...
								<div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 margin-top-20">
									...
									<div class="search-box pull-right">
										...
										<div class="dropdown-search"><?php florial_search_form_product(); ?></div>
									</div>
									<?php } ?>
									<!-- End Search -->
								</div>
