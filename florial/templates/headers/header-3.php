	<?php 
		...
		$show_compare = (isset($florial_settings['show-compare']) && $florial_settings['show-compare']) ? ($florial_settings['show-compare']) : false;
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 hidden-sm hidden-xs">
							<?php if( isset($florial_settings['delivery']) && $florial_settings['delivery'] ) : ?>
							<div class="delivery hidden-xs">
								<?php echo esc_html($florial_settings['delivery']); ?>
							</div>
							<?php endif; ?>
						</div>
					</div>
