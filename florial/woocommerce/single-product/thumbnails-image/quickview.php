...
remove_action( 'woocommerce_single_product_summary', 'florial_add_thumb_single_product', 40 );
remove_action( 'woocommerce_after_single_product', 'florial_sticky_cart', 50 );
remove_action( 'woocommerce_single_product_summary', 'florial_get_countdown', 20 );
remove_action( 'woocommerce_single_product_summary', 'florial_add_social', 45 );
remove_action( 'woocommerce_single_product_summary', 'florial_add_loop_wishlist_link', 35 );
remove_action( 'woocommerce_single_product_summary', 'florial_add_loop_compare_link', 36 );
...
<div id="quickview-slick-carousel">
	<div class="images">
		<div class="scroll-image">
			<div class="image-additional slick-carousel" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
				<?php
				$attributes = array(
					'id'						=> "image", 	
					'title'                   => $image_title,
