...
$shop_layout  		= florial_get_config('shop-layout','boxed');
$current_category 		= get_queried_object();
$show_subcategories 	= florial_get_config('show-subcategories',false);
...
<div class="<?php echo esc_attr($category_style); ?>  shop-layout-<?php echo esc_attr($shop_layout); ?>">
	<?php if( function_exists('is_shop') && is_shop() && $category_style == 'only_categories' && apply_filters( 'florial_custom_category', $html = '' ) ): ?>
	<div class="container">
		<div class="main-archive-product">
			<ul class="woocommerce-product-category row">
				<?php florial_woocommerce_output_product_categories(); ?>
			</ul>
		</div>
	</div>
	<?php else: ?>
		<div class="container">
			<div class="main-archive-product row">
				<?php if(($category_style == 'sidebar' || $category_style == 'filter_drawer') && is_active_sidebar('sidebar-product')): ?>	
					<div class="bwp-sidebar sidebar-product <?php echo esc_attr(florial_get_class()->class_sidebar_left); ?>">
						<?php if( $category_style == 'sidebar' || $category_style == 'filter_drawer'): ?>
							<div class="button-filter-toggle hidden-lg hidden-md">
								<?php echo esc_html__("Close","florial") ?>
							</div>
						<?php endif; ?>
				...
				<?php endif; ?>
				<div class="<?php echo esc_attr(florial_get_class()->class_product_content); ?>" >
					<?php do_action( 'woocommerce_archive_description' ); ?>
					<?php if ( have_posts() ) : ?>
						<div class="bwp-top-bar top clearfix">				
							<?php florial_category_top_bar(); ?>							
						</div>
