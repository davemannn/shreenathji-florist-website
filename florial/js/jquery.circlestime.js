...
(function ($) {
  ...
  TC_Instance.prototype.initialize = function (clear_listeners) {
    ...
    this.data.attributes.radius =
      (this.data.attributes.item_size * 0.8 - this.data.attributes.line_width) / 2;
    ...
    for (var key in this.data.text_elements) {
      ...
      headerElement.css(
        "line-height",
        Math.round(this.config.text_size * this.data.attributes.item_size) + "px",
      );
  ...
  TC_Instance.prototype.radialFade = function (x, y, color, from, key) {
    ...
    for (i = 0; from <= 1 && from >= 0; i++) {
      ...
      (function () {
        var delay = 50 * i;
        var rgba =
          "rgba(" + rgb.r + ", " + rgb.g + ", " + rgb.b + ", " + Math.round(from * 10) / 10 + ")";
