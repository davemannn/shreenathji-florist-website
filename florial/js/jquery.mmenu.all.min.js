        ...
        (e[n].prototype = {
          ...
          openPanel: function (t, i) {
            if (
              ...
              t &&
                t.length &&
                (t.is("." + s.panel) || (t = t.closest("." + s.panel)), t.is("." + s.panel)))
            ) {
              var o = this;
            ...
            r.$body.on(o.click + "-oncanvas", "a[href]", function (i) {
              ...
              if (!o && r && d.length > 1 && "#" == d.slice(0, 1))
                try {
                  var c = e(d, t.$menu);
                  c.is("." + s.panel) &&
                    ((o = !0), t[a.parent().hasClass(s.vertical) ? "togglePanel" : "openPanel"](c));
                } catch (h) {}
              if (
                (o && i.preventDefault(),
                !o &&
          ...
          _fireMatchMedia: function () {
            for (var e in this.mtch)
              for (
                var t = window.matchMedia && window.matchMedia(e).matches ? "yes" : "no", n = 0;
            ...
            var i = !1,
              s = function (n) {
                ("undefined" != typeof n && n.target != e[0]) ||
                  (i || (e.unbind(o.transitionend), e.unbind(o.webkitTransitionEnd), t.call(e[0])),
                  (i = !0));
              };
                ...
                n.find("." + i.listview)
                  ...
                  .each(function () {
                    var n = e(this),
                      ...
                      o = e[t].i18n(
                        r.text[
                          $prev.parent().is("." + i.vertical) ? "toggleSubmenu" : "openSubmenu"
                        ],
                      );
      ...
      ((e[t].addons[n] = {
        setup: function () {
          ...
          if (
            ...
            for (
              var a = this.opts.offCanvas ? this.$menu.add(o.$html) : this.$menu, r = [], l = 0;
              l <= s.visible.max;
              l++
            )
              r.push(i.columns + "-" + l);
      ...
      ((e[s].addons[a] = {
        ...
        add: function () {
          return "function" != typeof Hammer || Hammer.VERSION < 2
            ? ((e[s].addons[a].add = function () {}), void (e[s].addons[a].setup = function () {}))
              ...
              var h = function (e, t) {
                  ...
                  return (
                    "after" == v
                      ...
                      : ((y = "x" == e ? g : b),
                        (w = y - C),
                        (n[f] = "calc( 100% - " + (y - d.offset.button[e]) + "px )"),
                        (n[h] = "auto"),
                  ...
                  if (this.vars.opened) {
                    ...
                    ((t = h.call(this, "y", t)),
                      ...
                      l.tip &&
                        this.$menu
                          .removeClass(
                            i.tipleft + " " + i.tipright + " " + i.tiptop + " " + i.tipbottom,
                          )
                          .addClass(t[1].join(" ")));
                  }
                };
        ...
        setup: function () {
          if (this.opts.offCanvas) {
            ...
            var a = function (e) {
              ...
              this.__refactorClass(e.find("." + t), t, "slideout")[s.elemInsertMethod](
    ...
    (function (e) {
      ...
      ((e[i].addons[s] = {
        setup: function () {
          ...
          if (
            ((l = e[i].glbl),
            ("boolean" != typeof o && "string" != typeof o) || (o = { enable: o }),
            "object" != typeof o && (o = {}),
            ...
            (this.bind("initMenu:after", function () {
              ...
              this.bind("initOpened:after", function () {
                this.__sr_aria(
                  this.$menu.children("." + a.mm("tabstart") + ", ." + a.mm("tabend")),
                  "hidden",
                  !0,
                );
              }));
            ...
            a.length &&
              (e.each(a, function (o) {
                ...
                for (var p = 0, v = 0, m = c.content.length; v < m; v++) {
                  ...
                  b
                    ? (p += b.call(s, h, c, r))
                    : ((b = c.content[v]), b instanceof e || (b = e(c.content[v])), h.append(b));
                }
      ...
      e[t].addons[n][i] = function (n, i, s) {
        ...
        return (
          this.bind("initNavbar:after", function (t) {
            ...
            for (
              var n = [], i = e('<span class="' + o.breadcrumbs + '"></span>'), a = t, l = !0;
              a && a.length;
            ) {
              if (
                (a.is("." + o.panel) || (a = a.closest("." + o.panel)), !a.hasClass(o.vertical))
              ) {
                var d = a
                  .children("." + o.navbar)
                  .children("." + o.title)
                  .text();
                (n.unshift(
                  l ? "<span>" + d + "</span>" : '<a href="#' + a.attr("id") + '">' + d + "</a>",
                ),
                  (l = !1));
              }
              a = a.data(r.parent);
            ...
            i.append(
              n.join('<span class="' + o.separator + '">' + s.breadcrumbSeparator + "</span>"),
    ...
    (function (e) {
      ...
      ((e[i].addons[s] = {
        ...
        clickAnchor: function (i, o) {
          if (
            ((d = !1), o && this.opts[s].scroll && this.opts.offCanvas && l.$page && l.$page.length)
          ) {
            var r = i.attr("href");
            n(r) &&
              ((d = e(r)), l.$html.hasClass(a.mm("widescreen")) && t(this.conf[s].scrollOffset));
          }
        },
      }),
                        ...
                        if (t != _) {
                          if (
                            ...
                            m.each(function () {
                              var t = e(this),
                                n = b;
                              (d.showTextItems || (d.showSubPanels && t.find("." + s.next))) &&
                                (n = g);
                              var i = t.data(a.searchtext) || t.children(n).text();
                              i.toLowerCase().indexOf(_) > -1 &&
                                t.add(t.prevAll("." + s.divider).first()).removeClass(s.hidden);
                            }),
                            d.showSubPanels &&
                              n.each(function (t) {
                                var n = e(this);
                                l.__filterListItems(n.find("." + s.listview).children()).each(
                                  function () {
                                    var t = e(this),
                                      n = t.data(a.child);
                          ...
                          (r
                            .find("." + s.noresultsmsg)
                            [m.not("." + s.hidden).length ? "addClass" : "removeClass"](s.hidden),
              ...
              if (r.add) {
                ...
                (o
                  ...
                  this.$indexer ||
                    ...
                    this.$indexer
                      .children()
                      .on(a.mouseover + "-" + n + " " + i.touchstart + "-" + n, function (t) {
                ...
                var l = function (e) {
                  ((e = e || this.$pnls.children("." + i.opened)),
                    this.$menu[(e.hasClass(i.hasindexer) ? "add" : "remove") + "Class"](
                      i.hasindexer,
                    ));
                };
              ...
              (this.__refactorClass(t.find("input"), this.conf.classNames[n].toggle, "toggle"),
                ...
                t.find("input." + i.toggle + ", input." + i.check).each(function () {
                  ...
                  n.children('label[for="' + o + '"]').length ||
                    (t.attr("id", o),
                    n.prepend(t),
                    e('<label for="' + o + '" class="' + i[a] + '"></label>').insertBefore(
